    ...
    <>
      <div className="h-full">
        ...
        <div className="px-5 py-6 mx-auto">
          ...
          <ul className="list-disc py-2 px-8">
            ...
            <li className="py-2">
              <p>
                ...
                in this Agreement) refers to Nagrik AI.
              </p>
            </li>
            <li className="py-2">
              <p>
            ...
            <li className="py-2">
              <p>
                <strong>Website</strong> refers to Nagrik AI, accessible from{" "}
                <a
                  href="https://www.nagrikai.in"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.nagrikai.in
                </a>
              </p>
            </li>
            <li className="py-2">
          ...
          <h4 className="font-bold py-2 text-lg">Personal Data</h4>
          <p className="text-left py-2">
          ...
          <h4 className="font-bold text-lg py-2">Usage Data</h4>
          <p className="py-2">
          ...
          <h4 className="py-2 font-bold text-lg">
          ...
          <h3 className="py-2 text-xl font-bold">Use of Your Personal Data</h3>
          ...
          <h4 className="text-lg font-bold py-2">Business Transactions</h4>
          <p className="py-2">
          ...
          <h4 className="text-lg font-bold py-2">Law enforcement</h4>
          <p className="py-2">
          ...
          <h4 className="py-2 text-lg font-bold">Other legal requirements</h4>
          <p className="py-2">
          ...
          <h3 className="py-2 font-bold text-xl">
          ...
          <h2 className="py-2 font-bold text-2xl">Links to Other Websites</h2>
          <p className="py-2">
          ...
          <h2 className="py-2 font-bold text-2xl">Contact Us</h2>
          <p className="py-2">
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ul>
            <li className="py-2">By email: cypronium2004@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
