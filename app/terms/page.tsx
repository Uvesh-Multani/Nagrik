    ...
    <>
      <div className="h-full">
        ...
        <div className="px-5 py-6 mx-auto">
          <h1 className="font-bold text-4xl pb-3">Terms and Conditions</h1>
          <p className="text-gray-500 pb-4">Last updated: December 25, 2024</p>
          ...
          <p className="text-left py-2">
            We are Nagrik (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;) , a company
            registered in India at Surat , Surat , Gujarat 394602 .
          </p>
          <p className="text-left py-2">
            We operate the website{" "}
            <a
              href="https://www.nagrikai.in"
          ...
          <p className="text-left py-2">
            You can contact us by email at cypronium2004@gmail.com or by mail to
            Surat , Surat , Gujarat 394602 , India .
          </p>
          <p className="text-left py-2">
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ( &quot;you&quot;),
            and Nagrik AI, concerning your access to and use of the Services.
          ...
          <h2 className="font-bold text-2xl py-4">Table of Contents</h2>
          <ul>
            <li>
        ...
        hover:underline"
          ...
          <section id="our-services" className="my-8">
          ...
          <section id="intellectual-property-rights" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>2. INTELLECTUAL PROPERTY RIGHTS</a>
            </h2>
            <p className="text-lg leading-relaxed">
            ...
            <p className="text-lg leading-relaxed">
              ...
              Terms, please address your request to: cypronium2004@gmail.com. If
          ...
          <section id="use-representations" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>3. USER REPRESENTATION</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="user-registration" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>4. USER REGISTRATION</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="purchases-and-payment" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>5. PURCHASES AND PAYMENT</a>
            </h2>
            <p className="text-lg leading-relaxed">
              ...
              time. All payments shall be in __________.
              <br />
              <br />
          ...
          <section id="prohibited-activities" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 6. PROHIBITED ACTIVITIES</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="user-generated-contributions" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>7. USER GENERATED CONTRIBUTIONS</a>
            </h2>
            <p className="text-lg leading-relaxed">
              ...
              with the Service&apos;s Privacy Policy. When you create or make
              available any Contributions, you thereby represent and warrant
              that:
            </p>
          </section>

          <section id="contribution-license" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>8. CONTRIBUTION LICENSE</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="social-media" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>9. SOCIAL MEDIA</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="services-management" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a>10. SERVICES MANAGEMENT</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="privacy-policy" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 11. PRIVACY POLICY</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="term-and-termination" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 12. TERM AND TERMINATION</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="modifications-and-interruptions" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 13. MODIFICATIONS AND INTERRUPTIONS</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="governing-law" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 14. GOVERNING LAW</a>
            </h2>
            <p className="text-lg leading-relaxed">
              These Legal Terms shall be governed by and defined following the
              laws of India . Nagrik AI and yourself irrevocably consent that
          ...
          <section id="dispute-resolution" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 15.DISPUTE RESOLUTION</a>
            </h2>
            ...
            <h4 className="text-lg font-semibold py-2 ">Binding Arbitration</h4>
            <p className="text-lg leading-relaxed">
            ...
            <h4 className="text-lg font-semibold py-2 ">Restrictions</h4>
            <p className="text-lg leading-relaxed">
          ...
          <section id="corrections" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 16. CORRECTIONS</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="disclaimer" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 17. DISCLAIMER</a>
            </h2>
            <p className="text-lg leading-relaxed">
              ...
              THE ACCURACY OR COMPLETENESS OF THE SERVICE&apos;S CONTENT OR THE
          ...
          <section id="limitations-of-liability" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 18. LIMITATIONS OF LIABILITY</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="indemnification" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 19. INDEMNIFICATION</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="user-data" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">
              <a> 20. USER DATA</a>
            </h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="miscellaneous" className="my-8">
            <h2 className="text-2xl font-semibold mb-4">22. MISCELLANEOUS</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section id="contact-us" className="my-8">
            ...
            Surat
            <br />
            Surat , Gujarat 394602
            <br />
            India
            <br />
            <br />
            <p className="font-bold text-gray-700">cypronium2004@gmail.com</p>
          </section>
        </div>
      </div>
    </>
